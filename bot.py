...
# --- KEEP-ALIVE (Hugging Face ko active rakhne ke liye) ---
...
def inbox_monitor_worker(chat_id, email):
    ...
    while chat_id in user_sessions and user_sessions[chat_id]['email'] == email:
        try:
            # Body Fix: Increased timeout for HF stable response
            ...
            if resp.status_code == 200:
                ...
                for mail in inbox:
                    ...
                    if mail_id not in session['seen_ids']:
                        ...
                        # Body formatting fix
                        mail_body = mail.get('body', 'No content').strip()
        ...
        time.sleep(10) # 10 seconds gap to avoid rate limiting on HF
...
if __name__ == "__main__":
    print(f"[SYSTEM] Bot is starting with HF Backend...")
